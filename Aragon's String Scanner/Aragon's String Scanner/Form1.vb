...
Public Class Main
    ...
    Private Sub DirectoryBrowserButtonClick(sender As Object, e As EventArgs) Handles directoryBrowser.Click
    ...
    Private Sub ScanButton_Click(sender As Object, e As EventArgs) Handles scanBtn.Click
        Try
            ...
            If detectedAmount = 0 Then
                mainLog.AppendText("[ASS] >> No results were found!" + vbNewLine)
            Else
                mainLog.AppendText("[ASS] >> Found total of " & detectedAmount & " results" + vbNewLine)
            End If
    ...
    Private Sub Finish_Tick(sender As Object, e As EventArgs) Handles Finish.Tick
    ...
    Private Sub WebsiteButton_Click(sender As Object, e As EventArgs) Handles openWebsite.Click
        Process.Start("www.aragonloaders.ml")
    End Sub

    Private Sub ManualSave_Button(sender As Object, e As EventArgs) Handles saveLog.Click
        Dim file As System.IO.StreamWriter
        Directory.CreateDirectory(Environment.CurrentDirectory() & "\scans")
        file = My.Computer.FileSystem.OpenTextFileWriter(Environment.CurrentDirectory() & "\scans\scan-results" & ".txt", False)
        file.WriteLine(mainLog.Text)
